...
for i = 1 : max(arraysize)
    ...
    subplot(1,1,1)
    plot(Conejos, Linces,'.','markeredgecolor','k','markerfacecolor','k','markersize',14)
    PEx=[beta/delta]
    PEy=[alpha/gamma]
    plot(PEx, PEy,'.','markeredgecolor','m','markerfacecolor','m','markersize',20)
    legend('Soluciones númericas','Poblaciones','P_2')
    ...
    %title(['Conejos y Linces en función del tiempo'],'fontsize',12)
    %xlabel('Tiempo [años]')
